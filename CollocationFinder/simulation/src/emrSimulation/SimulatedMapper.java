...
public abstract class SimulatedMapper<KI,VI,KO,VO> extends Mapper<KI, VI, KO, VO> {
    ...
    private final Map<KI, VI> input;
    private final Context context;
    private final Map<KO, Iterable<VO>> output;
    private final Configuration conf;

    public Map<KO, Iterable<VO>> getOutput() {
        return output;
    }
        ...
        context = new Context() {
            ...
            public void write(KO key, VO value) throws IOException, InterruptedException {
                if(! output.containsKey(key)){
                    output.put(key, new LinkedList<>());
                }
                ((LinkedList<VO>)output.get(key)).add(value);
            }
